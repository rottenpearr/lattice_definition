# Распознавание кристаллических решеток
...
1. `РАЗВИТИЕ СИСТЕМЫ РАСПОЗНАВАНИЯ ТИПОВ КРИСТАЛЛИЧЕСКИХ РЕШЕТОК С ПРИМЕНЕНИЕМ МЕТОДОВ РАДИАЛЬНОГО РАСПРЕДЕЛЕНИЯ БЛИЖАЙШИХ СОСЕДЕЙ И МАШИННОГО ОБУЧЕНИЯ` - Артюшин
2. `ВНЕДРЕНИЕ МЕХАНИЗМОВ РАСПОЗНАВАНИЯ ТИПОВ КРИСТАЛЛИЧЕСКИХ РЕШЕТОК ДЛЯ АВТОМАТИЗАЦИИ ОПРЕДЕЛЕНИЯ МЕТОДОВ МОЛЕКУЛЯРНО-ДИНАМИЧЕСКИХ ИССЛЕДОВАНИЙ` - Маркова
3. `РАЗВИТИЕ СИСТЕМЫ ГЛОБАЛЬНОГО РАСПОЗНАВАНИЯ ТИПОВ КРИСТАЛЛОВ С ПРИМЕНЕНИЕМ МЕТОДОВ AI/ML ДЛЯ ЧИСЛЕННОГО МАТЕРИАЛОВЕДЕНИЯ` - Черняков 
...
- [ ] Подумать над папками со скриптами, отделить нормально бд и функции расчетов
- [ ] Нужно подумать как переписать логику под библиотеки numpy и прочие, матешу не оч хорошо выполнять чистым питоном (i guess)
- [ ] Длииииннные координаты в названии графиков ограничить
