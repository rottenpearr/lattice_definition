...
1. А что если больше 99 ионов проверять - **отметаем**, потому что масштабировать графики неудобно
2. Сделать уже датасет с этими корнер кейсами (около граней ионы) - **подумать**
3. Мы делаем локально по типу, но если по space группе то это глобально - **подумать как**, скорее всего на потом

Задачи:

1. Проверить написать письмо надо ли печатать централизованно постеры.
2. Придумать тесты нейронкой по супер непонятным кейсам решеткам.
3. Декомпозировать статьи и **ПАТЕНТЫ** на уровни, в каких блоках мы отличаемся.
4. Можно составить файл со ссылками на теорию и словарем терминов и определений.

## 10.11.25

1 metod - радианное распределение и в каких оно задачах

2 metod BURDUKOVA - в шуме разные кристаллы

2 критерий:
- обработка молекулярной динамики
- бабки - либо заработать, либо меньше траты
- про то что чисто матеша нельзя говорить
- прототип - есть

**ВАЖНО** - есть ли где-то ядерное сглаживание?
